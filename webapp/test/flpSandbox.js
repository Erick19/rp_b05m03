		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsproy01proy01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsproy01proy01-display": {
								"semanticObject": "nsproy01proy01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsproy01.proy01",
									"url": sap.ui.require.toUrl("nsproy01/proy01")
								}
							}
						}
					}
